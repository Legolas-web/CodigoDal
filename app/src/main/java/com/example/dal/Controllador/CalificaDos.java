...
public class CalificaDos extends AppCompatActivity {

    private JsonPlaceHolderApi jsonPlaceHolderApi;

    private String  idUser, taller;
    private TextView lblFecha_2, res1_2, res2_2, res3_2, res4_2, res5_2, res6_2, res7_2, res8_2, res9_2, res10_2, res11_2, res12_2, res13_2, res14_2, res15_2, res16_2, res17_2, res18_2;
    ...
    private Button btnCalificar2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_califica_dos);
        ...
        btnCalificar2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (not1.length() == 0 || not2.length() == 0 || not3.length() == 0 || not4.length() == 0 || not5.length() == 0 || not6.length() == 0 || not7.length() == 0 || not8.length() == 0 || not9.length() == 0 || not10.length() == 0 || not11.length() == 0 || not12.length() == 0 || not13.length() == 0 || not14.length() == 0 || not15.length() == 0 || not16.length() == 0 || not17.length() == 0 || not18.length() == 0){
                    ...
                    if (r1 == 1 && r2 == 1 && r3 == 1 && r4 == 1 && r5 == 1 && r6 == 1 && r7 == 1 && r8 == 1 && r9 == 1 && r10 == 1 && r11 == 1 && r12 == 1 && r13 == 1 && r14 == 1 && r15 == 1 && r16 == 1 && r17 == 1 && r18 == 1){
                        ...
                        Intent intent = new Intent(CalificaDos.this, AdminTurus.class);
    ...
    private void mtdCargarView() {
        ...
        btnCalificar2 = (Button)findViewById(R.id.btn_califica_taller_2);
        lblFecha_2 = (TextView)findViewById(R.id.lblFecha2);

        res1_2 = (TextView)findViewById(R.id.lblRes1_ta2);
        res2_2 = (TextView)findViewById(R.id.lblRes2_ta2);
        res3_2 = (TextView)findViewById(R.id.lblRes3_ta2);
        res4_2 = (TextView)findViewById(R.id.lblRes4_ta2);
        res5_2 = (TextView)findViewById(R.id.lblRes5_ta2);
        res6_2 = (TextView)findViewById(R.id.lblRes6_ta2);
        res7_2 = (TextView)findViewById(R.id.lblRes7_ta2);
        res8_2 = (TextView)findViewById(R.id.lblRes8_ta2);
        res9_2 = (TextView)findViewById(R.id.lblRes9_ta2);
        res10_2 = (TextView)findViewById(R.id.lblRes10_ta2);
        res11_2 = (TextView)findViewById(R.id.lblRes11_ta2);
        res12_2 = (TextView)findViewById(R.id.lblRes12_ta2);
        res13_2 = (TextView)findViewById(R.id.lblRes13_ta2);
        res14_2 = (TextView)findViewById(R.id.lblRes14_ta2);
        res15_2 = (TextView)findViewById(R.id.lblRes15_ta2);
        res16_2 = (TextView)findViewById(R.id.lblRes16_ta2);
        res17_2 = (TextView)findViewById(R.id.lblRes17_ta2);
        res18_2 = (TextView)findViewById(R.id.lblRes18_ta2);

        id1 = (TextView)findViewById(R.id.lblResId1_ta2);
        id2 = (TextView)findViewById(R.id.lblResId2_ta2);
        id3 = (TextView)findViewById(R.id.lblResId3_ta2);
        id4 = (TextView)findViewById(R.id.lblResId4_ta2);
        id5 = (TextView)findViewById(R.id.lblResId5_ta2);
        id6 = (TextView)findViewById(R.id.lblResId6_ta2);
        id7 = (TextView)findViewById(R.id.lblResId7_ta2);
        id8 = (TextView)findViewById(R.id.lblResId8_ta2);
        id9 = (TextView)findViewById(R.id.lblResId9_ta2);
        id10 = (TextView)findViewById(R.id.lblResId10_ta2);
        id11 = (TextView)findViewById(R.id.lblResId11_ta2);
        id12 = (TextView)findViewById(R.id.lblResId12_ta2);
        id13 = (TextView)findViewById(R.id.lblResId13_ta2);
        id14 = (TextView)findViewById(R.id.lblResId14_ta2);
        id15 = (TextView)findViewById(R.id.lblResId15_ta2);
        id16 = (TextView)findViewById(R.id.lblResId16_ta2);
        id17 = (TextView)findViewById(R.id.lblResId17_ta2);
        id18 = (TextView)findViewById(R.id.lblResId18_ta2);

        nota1 = (EditText)findViewById(R.id.txtNota1_ta2);
        nota2 = (EditText)findViewById(R.id.txtNota2_ta2);
        nota3 = (EditText)findViewById(R.id.txtNota3_ta2);
        nota4 = (EditText)findViewById(R.id.txtNota4_ta2);
        nota5 = (EditText)findViewById(R.id.txtNota5_ta2);
        nota6 = (EditText)findViewById(R.id.txtNota6_ta2);
        nota7 = (EditText)findViewById(R.id.txtNota7_ta2);
        nota8 = (EditText)findViewById(R.id.txtNota8_ta2);
        nota9 = (EditText)findViewById(R.id.txtNota9_ta2);
        nota10 = (EditText)findViewById(R.id.txtNota10_ta2);
        nota11 = (EditText)findViewById(R.id.txtNota11_ta2);
        nota12 = (EditText)findViewById(R.id.txtNota12_ta2);
        nota13 = (EditText)findViewById(R.id.txtNota13_ta2);
        nota14 = (EditText)findViewById(R.id.txtNota14_ta2);
        nota15 = (EditText)findViewById(R.id.txtNota15_ta2);
        nota16 = (EditText)findViewById(R.id.txtNota16_ta2);
        nota17 = (EditText)findViewById(R.id.txtNota17_ta2);
        nota18 = (EditText)findViewById(R.id.txtNota18_ta2);
    ...
    private void mtdConsultaRespuesta() {
        ...
        Call<List<clRespuesta>> call = jsonPlaceHolderApi.getRespuestasTaller2(idEnvia);
    ...
    private void mtdDatosTexViews(String idres, String res, String fecha, String pregunta) {
        ...
        String p1 = "2", p2 = "3_1", p3 = "3_2", p4 = "3_3", p5 = "3_4", p6 = "4", p7 = "5", p8 = "6", p9 = "7_1", p10 = "7_2", p11 = "7_3", p12 = "8", p13 = "9_1_1", p14 = "9_1_2", p15 = "9_1_3", p16 = "9_2_1", p17 = "9_2_2", p18 = "9_2_3";

        lblFecha_2.setText(fecha);
